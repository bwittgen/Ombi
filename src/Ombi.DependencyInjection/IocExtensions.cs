...
using Ombi.Api.External.NotificationServices.Mattermost;
using Ombi.Api.External.NotificationServices.Notifications;
...
using Ombi.Api.External.NotificationServices.CloudService;
...
namespace Ombi.DependencyInjection
{
    ...
    public static class IocExtensions
    {
        ...
        public static void RegisterServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IArrHealthProbe, ArrHealthProbe>();
